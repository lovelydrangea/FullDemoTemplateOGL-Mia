...
extern unsigned int TextureFromFile(HWND hWnd, const char* path, const string& directory, bool rotateX = false, bool rotateY = true, bool alpha = false, struct UTILITIES_OGL::ImageDetails* img = NULL);
...
public:
    ...
    Model(HWND hWnd,string const& path, bool rotationX = false, bool rotationY = true, bool gamma = false) : gammaCorrection(gamma) {
...
//        glm::vec3 lightPos(1.2f, 1.0f, 2.0f);
        ...
        gpuDemo.setVec3("viewPos", *cameraDetails.Position);

        // view/projection transformations
        gpuDemo.setMat4("projection", cameraDetails.currentProjection);
        gpuDemo.setMat4("view", cameraDetails.currentView);
...
//			model = glm::translate(model, glm::vec3(cameraDetails.Position->x, cameraDetails.Position->y - 5, cameraDetails.Position->z)); // translate it down so it's at the center of the scene
    ...
    bool getDefaultShader() { return this->defaultShader; }
    void setDefaultShader(bool defaultShader) { this->defaultShader = defaultShader; }
